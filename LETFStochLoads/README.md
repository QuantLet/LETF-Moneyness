...
## [<img src="https://github.com/QuantLet/Styleguide-and-FAQ/blob/master/pictures/qloqo.png" alt="Visit QuantNet">](http://quantlet.de/) **LETFStochLoads** [<img src="https://github.com/QuantLet/Styleguide-and-FAQ/blob/master/pictures/QN2.png" width="60" alt="Visit QuantNet 2.0">](http://quantlet.de/)
...
implied volatility surface as well as the CBOE Volatility Index (VIX) over the period Sep. 2014 -
Jul. 2015. The estimation of the dynamic semiparametric factor model with B-spline basis is
...
Output : 'plot of stochastic factor loadings of the SPY LETF option implied volatility surface and
the VIX index'
